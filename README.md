...
Opus 48 kbps preview MP3s for the **karoryfer.meatbass** sample library.
...
- **Source**: [`zulfikarbarbora-outl/karoryfer.meatbass`](https://github.com/zulfikarbarbora-outl/karoryfer.meatbass)
- **Branch**: `master`

## URL pattern

```
https://raw.githubusercontent.com/zulfikarbarbora-outl/meatbass-opus-48/master/<filename>.opus
```
